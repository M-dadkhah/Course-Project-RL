...
if __name__ == '__main__':
  ...
  mean_acc_rewards = evaluate_agent(agent, env_eval, n_episodes_to_evaluate)
  print(f' acc_reward: {mean_acc_rewards:.2f}')
  f.write(f' acc_reward: {mean_acc_rewards:.2f}\n')
  ...
  # np.save(path+f'runs/result'+ str(args.seed) +'.npy', learning_curve)
